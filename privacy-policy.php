<?php require_once('header.php') ?>
        <title>Best2Buy-Privacy Policy</title>
...
<div class="container px-5 text-break mt-5 mb-5">
    ...
    <h3>Privacy Policy for Best2Buy</h3>

    <p>At Best2Buy, accessible from https://best2buy.in/, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is collected and recorded by Best2Buy and how we
        use it.</p>

    <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us at info@best2buy.in.
    </p>

    <h3>Log Files</h3>

    <p>Best2Buy follows a standard procedure of using log files. These files log visitors when they visit websites. All
    ...
    <p>Like any other website, Best2Buy uses 'cookies'. These cookies are used to store information including visitors'
    ...
    <p>For more general information on cookies, please read <a
            href="https://www.generateprivacypolicy.com/#cookies">"Cookies" article from the Privacy Policy Generator</a>.
    </p>
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Best2Buy.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on Best2Buy, which are sent directly to users' browser.
    ...
    <p>Note that Best2Buy has no access to or control over these cookies that are used by third-party advertisers.</p>

    <h3>Third Party Privacy Policies</h3>

    <p>Best2Buy's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
    ...
    <p>Best2Buy does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
        the information that they shared and/or collect in Best2Buy. This policy is not applicable to any information
