...
<head>
    ...
    <title>Best2Buy-IG Profile DP</title>
...
<main>
        <div class="container text-center" id="wrapper">
            <h1 class="display-7" id='title'> Download Insta User's DPs...</h1>
        </div>
        <div class="container mt-5" id="serachBox">
            <input type="text" placeholder="Place username only..." autocomplete="off" class="form-controls rounded"
                id='input'required>
            <button class="btn btn-primary btn-block btn-lg mt-2 py-2" id="searchDP">Search</button>
        </div>
    ...
    <article>
        ...
        <section id="content" class="container-fluid d-flex flex-column">
            <h3>How to Download Instagram DP Online?</h3>
            <p>
                A decent dp always help you gain followers. For downloading Instagram DP..
                <li>Copy the username of a public profile.</li>
                <li>Paste the username in our tool.</li>
                <li>Wait until we present the DP for you..</li>
                <li>Click on the download button to save it.</li>
                <br><br>
              <strong>*Don't put any link in the search box. Just paste ther username of the profile without any quotations.</strong>
            </p>
